 ...
 */
type CLUSTERPARTITIONS_IMPL struct {
 ...
 * @return	Returns the []*models.ClusterPartition response from the API call
 */
func (me *CLUSTERPARTITIONS_IMPL) GetClusterPartitions (
            ids []int64,
            names []string) ([]*models.ClusterPartition, error) {
    //the endpoint path uri
    _pathUrl := "/public/clusterPartitions"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.ClusterPartition
 ...
 * @return	Returns the *models.ClusterPartition response from the API call
 */
func (me *CLUSTERPARTITIONS_IMPL) GetClusterPartitionById (
            id int64) (*models.ClusterPartition, error) {
    //the endpoint path uri
    _pathUrl := "/public/clusterPartitions/{id}"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.ClusterPartition = &models.ClusterPartition{}
    err = json.Unmarshal(_response.RawBody, &retVal)

 ...
 */
type CUSTOMREPORTING_IMPL struct {
     config configuration.CONFIGURATION
}

/**
 * Returns the list of node information running postgres database.
 * @return	Returns the []*models.PostgresNodeInfo response from the API call
 */
func (me *CUSTOMREPORTING_IMPL) GetPostgres () ([]*models.PostgresNodeInfo, error) {
    //the endpoint path uri
    _pathUrl := "/public/postgres"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.PostgresNodeInfo

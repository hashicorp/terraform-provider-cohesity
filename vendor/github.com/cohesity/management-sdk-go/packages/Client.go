 ...
 * @return	Returns the []*models.PackageDetails response from the API call
 */
func (me *PACKAGES_IMPL) ListPackages () ([]*models.PackageDetails, error) {
    //the endpoint path uri
    _pathUrl := "/public/packages"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.PackageDetails
 ...
 * @param    *models.DownloadPackageParameters        body     parameter: Required
 * @return	Returns the *models.DownloadPackageResult response from the API call
 */
func (me *PACKAGES_IMPL) CreateDownloadPackage (
            body *models.DownloadPackageParameters) (*models.DownloadPackageResult, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
}     //the endpoint path uri
    _pathUrl := "/public/packages/url"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.DownloadPackageResult = &models.DownloadPackageResult{}
    err = json.Unmarshal(_response.RawBody, &retVal)

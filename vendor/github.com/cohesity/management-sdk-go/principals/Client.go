 ...
 * @return	Returns the []*models.SourcesForSid response from the API call
 */
func (me *PRINCIPALS_IMPL) ListSourcesForPrincipals (
            sids []string) ([]*models.SourcesForSid, error) {
    //the endpoint path uri
    _pathUrl := "/public/principals/protectionSources"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.SourcesForSid
 ...
 * permissions for.
 * @param    *models.UpdateSourcesForPrincipalsParams        body     parameter: Required
 * @return	Returns the  response from the API call
 */
func (me *PRINCIPALS_IMPL) UpdateSourcesForPrincipals (
            body *models.UpdateSourcesForPrincipalsParams) (error) {
 ...
 * @param    models.ObjectClassSearchPrincipalsEnum        objectClass          parameter: Optional
 * @param    *string                                           search               parameter: Optional
 * @param    []string                                          sids                 parameter: Optional
 * @param    *bool                                             includeComputers     parameter: Optional
 * @return	Returns the []*models.Principal response from the API call
 */
func (me *PRINCIPALS_IMPL) SearchPrincipals (
            domain *string,
            objectClass models.ObjectClassSearchPrincipalsEnum,
            search *string,
            sids []string,
            includeComputers *bool) ([]*models.Principal, error) {
    //the endpoint path uri
    _pathUrl := "/public/principals/searchPrincipals"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    _queryBuilder, err = apihelper.AppendUrlWithQueryParameters(_queryBuilder, map[string]interface{} {
        "domain" : domain,
        "objectClass" : models.ObjectClassSearchPrincipalsEnumToValue(objectClass),
        "search" : search,
        "sids" : sids,
 ...
 */
func (me *PRINCIPALS_IMPL) GetSessionUser () (*models.User, error) {
    //the endpoint path uri
    _pathUrl := "/public/sessionUser"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.User = &models.User{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @param    *models.UserDeleteParameters        body     parameter: Optional
 * @return	Returns the  response from the API call
 */
func (me *PRINCIPALS_IMPL) DeleteUsers (
            body *models.UserDeleteParameters) (error) {
    //the endpoint path uri
    _pathUrl := "/public/users"
 ...
 * @param    []string        emailAddresses        parameter: Optional
 * @param    *string         domain                parameter: Optional
 * @param    *bool           partialMatch          parameter: Optional
 * @return	Returns the []*models.User response from the API call
 */
func (me *PRINCIPALS_IMPL) GetUsers (
            tenantIds []string,
            allUnderHierarchy *bool,
            usernames []string,
            emailAddresses []string,
            domain *string,
            partialMatch *bool) ([]*models.User, error) {
    //the endpoint path uri
    _pathUrl := "/public/users"
 ...
 * @param    *models.UserParameters        body     parameter: Optional
 * @return	Returns the *models.User response from the API call
 */
func (me *PRINCIPALS_IMPL) CreateUser (
            body *models.UserParameters) (*models.User, error) {
    //the endpoint path uri
    _pathUrl := "/public/users"
 ...
 * @return	Returns the *models.User response from the API call
 */
func (me *PRINCIPALS_IMPL) UpdateUser (
            body *models.UserParameters) (*models.User, error) {
    //the endpoint path uri
    _pathUrl := "/public/users"
 ...
 */
func (me *PRINCIPALS_IMPL) GetUserPrivileges () ([]string, error) {
    //the endpoint path uri
    _pathUrl := "/public/users/privileges"
 ...
 * @param    *models.ResetS3SecretKeyParameters        body     parameter: Optional
 * @return	Returns the *models.NewS3SecretAccessKey response from the API call
 */
func (me *PRINCIPALS_IMPL) CreateResetS3SecretKey (
            body *models.ResetS3SecretKeyParameters) (*models.NewS3SecretAccessKey, error) {
    //the endpoint path uri
    _pathUrl := "/public/users/s3SecretKey"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.NewS3SecretAccessKey = &models.NewS3SecretAccessKey{}
    err = json.Unmarshal(_response.RawBody, &retVal)

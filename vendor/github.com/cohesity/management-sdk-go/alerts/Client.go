...
func (me *ALERTS_IMPL) GetNotificationRules () ([]*models.NotificationRule, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal []*models.NotificationRule
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *ALERTS_IMPL) DeleteNotificationRule (
            ruleId int64) (error) {
    //the endpoint path uri
    _pathUrl := "/public/alertNotificationRules/{ruleId}"
...
func (me *ALERTS_IMPL) GetAlerts (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    _queryBuilder, err = apihelper.AppendUrlWithQueryParameters(_queryBuilder, map[string]interface{} {
        ...
        "alertTypeBucketList" : models.AlertTypeBucketListEnumArrayToValue(alertTypeBucketList),
        "resolutionIdList" : resolutionIdList,
        "tenantIds" : tenantIds,
        "allUnderHierarchy" : allUnderHierarchy,
    })

...
func (me *LDAPPROVIDER_IMPL) GetLdapProvider (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.LdapProviderResponse
...
//validating required parameters
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.LdapProviderResponse = &models.LdapProviderResponse{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @return	Returns the *models.LdapProviderResponse response from the API call
 */
func (me *LDAPPROVIDER_IMPL) UpdateLdapProvider (
            body *models.UpdateLdapProviderParam) (*models.LdapProviderResponse, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
}     //the endpoint path uri
...
func (me *LDAPPROVIDER_IMPL) DeleteLdapProvider (
            id int64) (error) {
    //the endpoint path uri
    _pathUrl := "/public/ldapProvider/{id}"
...
func (me *LDAPPROVIDER_IMPL) GetLdapProviderStatus (
            id int64) (error) {
    //the endpoint path uri
    _pathUrl := "/public/ldapProvider/{id}/status"

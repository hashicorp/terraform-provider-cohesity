 ...
 * @param    *models.GroupDeleteParameters        body     parameter: Optional
 * @return	Returns the  response from the API call
 */
func (me *GROUPS_IMPL) DeleteGroups (
            body *models.GroupDeleteParameters) (error) {
    //the endpoint path uri
    _pathUrl := "/public/groups"
 ...
 */
func (me *GROUPS_IMPL) GetGroups (
            name *string,
            domain *string,
            tenantIds []string,
            allUnderHierarchy *bool) ([]*models.Group, error) {
    //the endpoint path uri
    _pathUrl := "/public/groups"
 ...
 * @param    *models.GroupParameters        body     parameter: Optional
 * @return	Returns the *models.Group response from the API call
 */
func (me *GROUPS_IMPL) CreateGroup (
            body *models.GroupParameters) (*models.Group, error) {
    //the endpoint path uri
    _pathUrl := "/public/groups"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.Group = &models.Group{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @return	Returns the *models.Group response from the API call
 */
func (me *GROUPS_IMPL) UpdateGroup (
            body *models.GroupParameters) (*models.Group, error) {
    //the endpoint path uri
    _pathUrl := "/public/groups"

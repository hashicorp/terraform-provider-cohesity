...
func (me *VIEWS_IMPL) ListNlmLocks (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.ListNlmLocksResponse = &models.ListNlmLocksResponse{}
...
func (me *VIEWS_IMPL) GetViewsByShareName (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.GetViewsByShareNameResult = &models.GetViewsByShareNameResult{}
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *VIEWS_IMPL) GetSmbConnections (
    ...
    //the endpoint path uri
    _pathUrl := "/public/smbConnections"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal []*models.SmbConnection
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *VIEWS_IMPL) GetViewDirQuotaInfo (
    ...
    //the endpoint path uri
    _pathUrl := "/public/viewDirectoryQuotas"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.DirQuotaInfo = &models.DirQuotaInfo{}
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *VIEWS_IMPL) GetFileLockStatusById (
    ...
    //the endpoint path uri
    _pathUrl := "/public/views/id/{id}/fileLocks"
...
//validating required parameters
    ...
    _pathUrl := "/public/views/rename/id/{id}"

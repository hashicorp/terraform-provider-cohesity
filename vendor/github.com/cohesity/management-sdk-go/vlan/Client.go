 ...
 * @param    *bool           skipPrimaryAndBondIface     parameter: Optional
 * @return	Returns the []*models.Vlan response from the API call
 */
func (me *VLAN_IMPL) GetVlans (
            tenantIds []string,
            allUnderHierarchy *bool,
            skipPrimaryAndBondIface *bool) ([]*models.Vlan, error) {
    //the endpoint path uri
    _pathUrl := "/public/vlans"
 ...
 * @param    *models.Vlan        body     parameter: Required
 * @return	Returns the *models.Vlan response from the API call
 */
func (me *VLAN_IMPL) CreateVlan (
            body *models.Vlan) (*models.Vlan, error) {
//validating required parameters
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.Vlan = &models.Vlan{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 */
func (me *VLAN_IMPL) RemoveVlan (
            id int64) (error) {
    //the endpoint path uri
    _pathUrl := "/public/vlans/{id}"
 ...
 * @return	Returns the *models.Vlan response from the API call
 */
func (me *VLAN_IMPL) GetVlanById (
            id int64) (*models.Vlan, error) {
    //the endpoint path uri
    _pathUrl := "/public/vlans/{id}"
 ...
 * @param    int64                   id       parameter: Required
 * @param    *models.Vlan        body     parameter: Optional
 * @return	Returns the *models.Vlan response from the API call
 */
func (me *VLAN_IMPL) UpdateVlan (
            id int64,
            body *models.Vlan) (*models.Vlan, error) {
    //the endpoint path uri
    _pathUrl := "/public/vlans/{id}"
